...
ActiveRecord::Schema.define(version: 20150611195927) do
  ...
  create_table "chem_units", force: :cascade do |t|
    t.string   "type"
    t.integer  "user_id"
  ...
  create_table "fert_units", force: :cascade do |t|
    t.string   "type"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "seed_units", force: :cascade do |t|
    t.string   "type"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "users", ["consultant_id"], name: "index_users_on_consultant_id"
